...
/** The mark: a labeled span — a bracketed entity tag, GLiNER's whole job. */
export function ChipMark(props: { class?: string }) {
  return (
    ...
    >
      <path
        d="M9 8v6a2 2 0 0 1-2 2 2 2 0 0 1 2 2v6M23 8v6a2 2 0 0 0 2 2 2 2 0 0 0-2 2v6"
        stroke="currentColor"
        stroke-width="2"
        ...
        class="text-ink"
      />
      <circle cx="16" cy="16" r="3" fill="currentColor" class="text-accent" />
    </svg>
  );
}
