 ...
 * checkpoint named after its Hugging Face repo (e.g. `gliner2.5-small-v1`,
 * the same layout the gliner-rs CLI cache uses); every demo tab then lists
 * whichever of its models are found inside it, without re-picking a folder
                ...
                <Show
                  ...
                  fallback={
                    <p class="text-sm text-muted">
                      Pick a directory containing one subdirectory per checkpoint, each named after its
                      Hugging Face repo (e.g. <code class="font-mono text-xs">gliner2.5-small-v1</code>),
                      holding <code class="font-mono text-xs">config.json</code>,{" "}
                      <code class="font-mono text-xs">encoder_config/config.json</code>,{" "}
                      <code class="font-mono text-xs">tokenizer.json</code> and{" "}
                      <code class="font-mono text-xs">model.safetensors</code> — the same layout the
                      gliner-rs CLI cache directory uses.
                    </p>
                  }
                >
                  {(pending) => (
